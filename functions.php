...
function load_svg_sprite() {
    echo '<svg display="none" width="0" height="0" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <defs>
            ...
            <symbol id="swiper-arrow" viewBox="0 0 35 35">
                <path d="M35 0V35H0V0H35ZM2 33H33V2H2V33Z" fill="currentColor"/>
                <path d="M22.5 18L14.5 26V10L22.5 18Z" fill="currentColor"/>
            </symbol>
        </defs>   
    </svg>';
}
